 ...
 */
public class SessionAuditService extends BaseKontroller {

    private static Logger log = LoggerFactory.getLogger(SessionAuditService.class);
    ...
    public SessionAuditService(HttpServletRequest request, HttpServletResponse response) {
