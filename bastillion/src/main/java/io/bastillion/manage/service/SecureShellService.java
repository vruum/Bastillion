 ...
 */
public class SecureShellService extends BaseKontroller {

    static Map<Long, UserSchSessions> userSchSessionMap = new ConcurrentHashMap<>();
    private static Logger log = LoggerFactory.getLogger(SecureShellService.class);
    ...
    public SecureShellService(HttpServletRequest request, HttpServletResponse response) {
    ...
    public static void setUserSchSessionMap(Map<Long, UserSchSessions> userSchSessionMap) {
        SecureShellService.userSchSessionMap = userSchSessionMap;
    }
    ...
    public String disconnectTerm() {
        Long sessionId = AuthUtil.getSessionId(getRequest().getSession());
        if (SecureShellService.getUserSchSessionMap() != null) {
            UserSchSessions userSchSessions = SecureShellService.getUserSchSessionMap().get(sessionId);
