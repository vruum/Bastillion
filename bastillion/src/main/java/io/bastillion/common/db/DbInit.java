    ...
    public void init() {
        ...
        try {
            ...
            if (!rs.next()) {
                ...
                statement.executeUpdate("create table if not exists logins (username VARCHAR PRIMARY KEY, hashed_password varchar, user_id INTEGER, last_login_tm timestamp, created     timestamp)");
